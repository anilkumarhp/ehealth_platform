...
import { saveEntityToSession } from '../utils/sessionUtils';

// Generic card component that can be used for hospitals, doctors, pharmacies, and labs
export const EntityCardWithSession = ({ entity, type }) => {
  ...
  const handleBookingClick = (e) => {
    ...
    saveEntityToSession(getBookingTab(), entity);
...
export default EntityCardWithSession;